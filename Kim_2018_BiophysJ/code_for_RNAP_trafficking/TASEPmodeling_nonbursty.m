function lociList = TASEPmodeling_nonbursty(pauseProfile,promoter,totalLoci,kLoading,avgSpeed,pauseSite, pauseHeight)
%{
-About-
...
-Example-
TASEPmodeling_nonbursty('flat','P1nb',5,1/15,30,0,0)
...
geneLength = 3075; % nt 
polWidth = 35;  % nt
N_totalloci = 2; % <- change this value depending on the purpose
