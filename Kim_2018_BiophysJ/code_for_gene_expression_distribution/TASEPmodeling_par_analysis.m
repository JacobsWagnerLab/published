function ansAll = TASEPmodeling_par_analysis(pauseProfile,promoter,totalparRun,pauseSite, pauseHeight)
...
% For gene dosage effect
% see TASEPmodeling_par_analysis_genedosage
