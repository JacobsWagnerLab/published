function [DC,Posr,Cl]=constDegreeSingleCell(cellStruct,pxsize)
%-------------------------------------------------------------------------
%-------------------------------------------------------------------------
% function [DC,Posr,Cl]=constDegree(cellList,pxsize,frameId,cellId)
% @author: Manuel Campos - modified from Oleksii Sliusarenko and Setsu Hirano
% @date: May 13 2016
% @copyright 2015-2016 Yale University
%=========================================================================
% ********************** input **********************
%cellStruct: CellList you want to analyze (new cellList format) 
%pxsize: Pixel size
% ********************** output **********************
...
if ~isempty(cellStruct) && isfield(cellStruct,'signal0') && ~isempty(cellStruct.signal0)
        % get constriction profile
        prf = cellStruct.signal0;
        if isempty(prf) 
            return;
        end
        for ii=1:2
