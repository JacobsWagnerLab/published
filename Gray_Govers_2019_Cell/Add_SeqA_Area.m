function [cellList] = Add_SeqA_Area(cellList, path_to_images)
%{
-About-
Function to calculate the relative intracellular area of fluorescently
labeled SeqA. The field 'relative_seqA_area' is added for each cell in the
cellList.
...
-Outputs-
cellList:   updated cellList containing SeqA information, the field
            'relative_seqA_area' is added for each cell
...
-Keywords-
SeqA, Relative SeqA area, cellList, Oufti
...
seqA_images = Load_Image_Series(path_to_images);
