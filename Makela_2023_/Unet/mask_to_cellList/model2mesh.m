...
%% Patch notes:
% 2019-01-16, Yingjie Xiang 
%   Replaced the function the original function repmat_() with the
%   MATLAB built-in function repmat(). The .c source code cannot be found,
%   so it may be safer to use the built-in one, as we cannot compile the
%   original repmat_() anymore. The behavior of repmat() and repmat_() were
%   tested to be the same.
