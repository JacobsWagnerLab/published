...
tag_ind = [1 0 0 0 0];  % Choosing the parameter to be varied
...
for m = 2:2
    ...
    % Plot GR decay
    plot(Aq(indI:end), decay_curve{m}.GR(indI:end), '-','LineWidth',1.5, 'color', [0 0 1] ); hold on;
    
    % Plot mRNA decay
    plot(Aq(indI:end), decay_curve{m}.Xconc(indI:end), '-','LineWidth',1.5, 'color', [1 0 0]); hold on;
    
    % Plot RNAP_AF, ribo_AF decay
    plot(Aq(indI:end), decay_curve{m}.RNAP_AF(indI:end), 'o','LineWidth',1.5, 'color', [1 0 0] ); hold on;
    plot(Aq(indI:end), decay_curve{m}.ribo_AF(indI:end), 'o','LineWidth',1.5, 'color', [0 0 1] ); hold on;
