    ...
    def get_microtubule_speed_and_angles(self, time_lag):
        ...
        Returns:
            An updated microtubule dataframe with the following columns added:
                ...
                dataframe['central_line_distance_slope'] # a tuple with the minimum distance from the central line and the slope at that position of the central line
...
#        embryo_mask = self.get_embryo_mask(gut_channel, adaptive_threshold_parameters, close_iter, dilation, object_threshold)
        ...
        def get_distance_from_line(line_coords, point_coords):
            ...
            return (central_line_distance, central_line_slope)
...
#        plt.figure(figsize=(10,10))
        for traj in microtubule_df['microtubule_id'].unique():
            ...
            trajectory_df[['central_distance', 'central_slope']] = pd.DataFrame(trajectory_df['central_line_distance_slope'].tolist(), index=trajectory_df.index)               
