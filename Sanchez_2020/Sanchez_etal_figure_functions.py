...
def plot_embryo_masks(embryo_df, line_coords_path):
    """
    ...
    line_coords_path: string - the path to the central line coordinates folder (also provided in the JacobsWagnerLab GitHub repository)
    https://github.com/JacobsWagnerLab/published/blob/master/Sanchez_2020/Central_line_coordinates.zip
    """
    central_line_dict = {}
    path = line_coords_path
...
def plot_angle_distance_wrap(gut_df, mutant, min_length, plot_mean, save_path):
    ...
    Input:
        gut_df: panadas DataFrame including the instantaneous comet angles from 0 to 180 degrees and their distance from the central line
                ...
                The gut_df is a subset of the comet_df which is generated by concatenating the control, 10B_gut and 62_gut dataframes:
