...
% (P_auto). The result is used to generate Figure S4B.

% The phase diagram of P_auto is simulated, by varying two variables 
% (i)  number of reaction fluxes in the system
% (ii) The exponent of power-law function, used in weighting the dw. set
...
K_vec =[0:8:400]';                  % range of number of reaction fluxes 
