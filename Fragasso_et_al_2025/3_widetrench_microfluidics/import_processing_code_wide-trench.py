...
'''
This function inputs the cell_stack found in SuperSegger cell file and returns quantities:
...
# Wide-trench positions span both double- and single-digit indices
        ...
        for pos in pos_list:
            ...
            if not overwrite:
                ...
                if os.path.exists(output_path):
                    ...
                    df_name = pos + '_' + exp_name + '_cell_features_df.pkl'
                    if df_name in out_list:
                        print(df_name + ' was already computed -->> skip')
                        continue
                    else:
                        print(df_name + ' not computed already')
            ...
            for cell in cells_list:
                ...
                for i in cell_stack:
                    ...
                    rcm_x_list.append(rcm[1])
                    rcm_y_list.append(rcm[0])
                ...
                cell_features_df['rcm_x'] = rcm_x_list
                cell_features_df['rcm_y'] = rcm_y_list
                cell_features_df['r_off'] = [r_off] * len(cell_features_df)
            ...
            if save and len(cell_features_all_df) > 0:
                if bkg_sub:
                    ...
                    cell_ch_dict_name = pos + '_' + exp_name + '_cell_ch'
