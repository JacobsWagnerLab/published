function [ParB,ParA,tt,params,ParB_dxymax,ParA_state,ParA_0] = diffusing_multiple_chained_ParB_fixed_ParA_v4(params)
% UNDER CONSTRUCTION 
...
% returns n random XY pairs ([x1,x2,x3...; y1,y2,y3...]) using dPdx according to choice
  ...
  switch choice
    ...
    case 5 % X: special distribution for explanation movies
      ...
      rand_XY(1,:)=c*l0*(uni_rand(2,:)-0.5)+([0.25,0.4,0.55,0.68,0.77,0.85,0.9]*l0-l00);
...
% declare default values of parameters and change them to values specified in params_in 
  ...
  params0.totA=90;  % number of ParA
   params0.totB=2;  % number of ParB

  params0.R_B=0.05;
   params0.R_A=0.002;
  params0.R_B_link=0.014; 
  ...
  params0.x_B0=-0.59*ones(1,params0.totB);  params0.y_B0=0*ones(1,params0.totB); %params0.x_B0=-0.45*l_0;  params0.y_B0=0; % initial ParB coordinates
  ...
  params0.script='diffusing_multiple_chained_ParB_oscillating_ParA_v4_fixedA';
  params0.model='Diffusion/Binding, multi chained ParB';
   params0.version='04.23.2014';
