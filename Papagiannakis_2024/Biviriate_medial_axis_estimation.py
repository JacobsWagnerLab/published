...
def get_oned_coordinates(cell_mask, medial_axis_df, half_window=5): 
...
#                get_relative_distance(min_distance_abs, medial_axis_df, min_index, medial_axis_coords, pixel_x, pixel_y, half_window)
    ...
    cell_mask_df['oned_coords'] = cell_mask_df.apply(lambda x: get_pixel_projection(x.x, x.y, medial_axis_df, half_window), axis=1)
