...
1) Improved background subtraction courtesy of Alexandros Papagiannakis ([Makela et al., eLife 2024: Genome concentration limits cell growth and modulates proteome composition in Escherichia coli](https://elifesciences.org/articles/97465)).
...
2) Generation of a medial axis to estimate the midline rather than a skeleton. This comes from Alexandros Papagiannakis ([Papagiannaki et al., 2023, bioRxiv 10.1101/2024.10.08.617237v2](https://www.biorxiv.org/content/10.1101/2024.10.08.617237v2)). This does polynomial univariate fits on the x and y dimensions of the cell mask to generate a sub-pixel line from pole to pole. This step slows down the code, but its accuracy and reliability is undeniably useful. 
